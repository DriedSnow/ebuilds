...
inherit distutils-r1 git-r3 linux-info xdg
...
EGIT_REPO_URI="https://github.com/C0rn3j/sc-controller.git"
...
# Note: Release patches may fail on git master. Re-enable if needed.
# PATCHES=(
# 	"${FILESDIR}"/sc-controller-tomllib.patch
# )
